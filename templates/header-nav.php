<header id="header">
    ...
    <?php
    $socialToggle = security_opt( 'security-headersocial-toggle-settings' );
    $number     = security_opt( 'security_headtop_number' );
    $bntText1   = security_opt( 'security_headtop_btn1_text' );
    $bntText2   = security_opt( 'security_headtop_btn2_text' );

    if( !empty( $socialToggle ) || !empty( $number ) || !empty( $bntText1 ) || !empty( $bntText2 ) ){
        ?>
