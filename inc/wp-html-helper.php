...
// image default alt
if( ! function_exists( 'security_img_default_alt' ) ) {
	function security_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'security_img_tag' ) ) {
	function security_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = security_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'security_anchor_tag' ) ) {
	function security_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'security' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'security_heading_tag' ) ) {
	function security_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'security' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'security_paragraph_tag' ) ) {
	function security_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'security_other_tag' ) ) {
	function security_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'security_button_element ' ) ) {
	function security_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'security' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
