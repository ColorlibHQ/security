...
class Security_Enqueue {

	public $scripts = array();

	public function security_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'security_frontend_enqueue_scripts', ) );
	}

	public function security_frontend_enqueue_scripts( ) {
