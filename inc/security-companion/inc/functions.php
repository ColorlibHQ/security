...
function security_instagram_instance() {
...
// Blog Section
function security_blog_section( $postnumber ) {
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 single-blog">
            ...
            <div class="thumb">
                <?php 
                the_post_thumbnail( 'security_blogsect_post_thumb', array( 'class' => 'img-fluid' ) );
                ?>                                                  
            </div>
            <?php 
            endif;
...
// 
function security_section_heading( $title = '', $subtitle = '' ) {
    if( $title || $subtitle ):
    ?>
...
function security_contact7_form_content( $template, $prop ) {
...
add_filter( 'wpcf7_default_template', 'security_contact7_form_content', 10, 2 );
