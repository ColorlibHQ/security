...
class security_social_widget extends WP_Widget {
...
'security_social_widget', 


// Widget name will appear in UI
esc_html__( '[ Security ] Social Widget', 'security' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'security' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'security' );
}
...
} // Class security_social_widget ends here


// Register and load the widget
function security_social_load_widget() {
	register_widget( 'security_social_widget' );
}
add_action( 'widgets_init', 'security_social_load_widget' );