...
class security_newsletter_widget extends WP_Widget {
...
'security_newsletter_widget',


// Widget name will appear in UI
esc_html__( '[ Security ] Newsletter Form', 'security' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'security' ), ) 
);
...
?>
<div id="mc_embed_signup" class="security-subscribe-newsletter">
	<form target="_blank" novalidate action="<?php echo esc_url( $actionurl ); ?>" id="mc-embedded-subscribe-form" method="post" class="form-inline">
		<input type="email" name="EMAIL" placeholder="<?php esc_html_e( 'Email address', 'security' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Newsletter', 'security' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'security'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_html_e( 'Short Description:' ,'security'); ?></label> 
...
} // Class security_newsletter_widget ends here


// Register and load the widget
function security_newsletter_load_widget() {
	register_widget( 'security_newsletter_widget' );
}
add_action( 'widgets_init', 'security_newsletter_load_widget' );