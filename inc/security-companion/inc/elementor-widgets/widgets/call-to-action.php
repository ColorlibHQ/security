...
class Security_Cta extends Widget_Base {
	...
	public function get_title() {
		return __( 'Call To Action', 'security' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'cta_content',
            [
                'label' => __( 'Call To Action Content', 'security' ),
            ]
        );
        $this->add_control(
            'title',
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Everything You can imagine is right here', 'security' )
            ]
        );
        $this->add_control(
            'content',
        ...
        $this->add_control(
            'color_titlebold', [
                'label'     => __( 'Bold Title Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222',
                'selectors' => [
