...
class Security_Team_Member extends Widget_Base {
	...
	public function get_title() {
		return __( 'Team Member', 'security' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'team_sectcontent',
            [
                'label' => __( 'Team Section Top', 'security' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'team_memcontent',
			[
				'label' => __( 'Team Member', 'security' ),
			]
		);
		$this->add_control(
            'teamslider', [
                'label' => __( 'Create Team Member', 'security' ),
                ...
                'fields' => [
                    ...
                    [
                        'name' => 'fburl',
                        'label' => __( 'Facebook Url', 'security' ),
                        'type' => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                    [
                        'name' => 'twiturl',
                        'label' => __( 'Twitter Url', 'security' ),
                        'type' => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                    [
                        'name' => 'pinturl',
                        'label' => __( 'Pinterest Url', 'security' ),
                        'type' => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                    [
                        'name' => 'driburl',
                        'label' => __( 'Dribbble Url', 'security' ),
                        'type' => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                ],
		...
		$this->start_controls_section(
			'style_teaminfo', [
				'label' => __( 'Style Team Member Info', 'security' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_control(
            'team_imghov',
            [
                'label' => __( 'Member Image Hover Color', 'security' ),
        ...
        $this->add_control(
            'team_desigopt',
            [
                'label' => __( 'Designation Style', 'security' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_desigopt', [
                'label' => __( 'Designation Color', 'security' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->add_control(
			'color_iconhovopt', [
				'label' => __( 'Icon Hover Color', 'security' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
