...
class Security_About extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'aboutus_heading',
            [
                'label' => __( 'Section Heading', 'security' ),
            ]
        );
        $this->add_control(
            'aboutus_htitle',
            [
                'label'     => esc_html__( 'Title', 'security' ),
        ...
        $this->add_control(
            'aboutus_hsubtitle',
            [
                'label'     => esc_html__( 'Sub Title', 'security' ),
                'type'      => Controls_Manager::TEXT,
        ...
        $this->start_controls_section(
            'about_content',
            [
                'label' => __( 'About Content', 'security' ),
            ]
        );
        $this->add_control(
            'title',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'We Realize that there are reduced Wastege Stand out', 'security' )
            ]
        );
        $this->add_control(
            'content',
            [
                'label'         => esc_html__( 'Contact', 'security' ),
                'type'          => Controls_Manager::WYSIWYG,
                'label_block'   => true,
                'default'       => esc_html__( 'inappropriate behaviour is often laughed off as “boys will be boys,” women face higher conduct standards – especially in the workplace. That’s why it’s crucial that, as women.', 'security' )
            ]
        );
        $this->add_control(
            'featured_img',
            [
                'label'         => esc_html__( 'Featured Image', 'security' ),
