...
class Security_Pricing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing Table', 'security' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'pricing_content',
			[
				'label' => __( 'Pricing Table', 'security' ),
			]
		);
        $this->add_control(
            'pricing_title', [
        ...
        $this->add_control(
            'pricing_durationunit', [
                'label' => __( 'Duration Unit', 'security' ),
                'type'  => Controls_Manager::TEXT,
                'default' => 'per'
        ...
        $this->add_control(
            'features', [
                'label' => __( 'Features List', 'security' ),
                'type' => Controls_Manager::REPEATER,
                'title_field' => '{{{ label }}}',
                'fields' => [
                    [
                        'name' => 'label',
                        'label' => __( 'Feature', 'security' ),
                        'type' => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => '10 GB Space'
                    ]
        ...
        $this->add_control(
            'pricing_btnlabel', [
                'label' => __( 'Button Label', 'security' ),
                'type'  => Controls_Manager::TEXT,
                'label_block' => true
    ...
    $this->start_controls_section(
        'style_table', [
            'label' => __( 'Pricing Table Style', 'security' ),
    ...
    $this->add_control(
        'color_titlebg', [
            'label'     => __( 'Title Background Color', 'security' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#fbfcff',
            'selectors' => [
    ...
    $this->add_control(
        'color_pricebbg', [
            'label'     => __( 'Price box Background Color', 'security' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#f9f9ff',
            'selectors' => [
    ...
    $this->add_control(
        'color_priceboxhoverbg', [
            'label'     => __( 'Price box Hover Background Color', 'security' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#fab700',
            'selectors' => [
