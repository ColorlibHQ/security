...
class Security_Banner extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'banner_content',
            [
                'label' => __( 'Banner Section Content', 'security' ),
            ]
        );
        $this->add_control(
            'banner_titleone',
            [
                'label'         => esc_html__( 'Title #1', 'security' ),
        ...
        $this->add_control(
            'banner_titletwo',
            [
                'label'         => esc_html__( 'Title #2', 'security' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true
            ]
        );
        $this->add_control(
            'banner_desc',
            [
                'label'         => esc_html__( 'Description', 'security' ),
        ...
        $this->add_control(
            'banner_btnlabel',
            [
                'label'         => esc_html__( 'Button Label', 'security' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'Explore Us', 'security' )
            ]
        );
        $this->add_control(
            'banner_btnurl',
            [
                'label'         => esc_html__( 'Button Url', 'security' ),
        ...
        $this->start_controls_section(
            'style_textcolor', [
                'label' => __( 'Style Content', 'security' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_titleone', [
                'label'     => __( 'Title #1 Color', 'security' ),
        ...
        $this->add_control(
            'color_titletwo', [
                'label'     => __( 'Title #2 Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'name'          => 'banneroverlay',
                'label'         => __( 'Overlay Background', 'security' ),
                'separator'     => 'before',
                'description'   => esc_html__( 'Set banner overlay background color.', 'security' ),
                'types'         => [ 'gradient' ],
        ...
        $this->start_controls_section(
            'style_btn', [
                'label' => __( 'Style Button', 'security' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_btnlabel', [
                'label'     => __( 'Button Label Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhoverlabel', [
                'label'     => __( 'Button Hover Label Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fab700',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnborder', [
                'label'     => __( 'Button Border Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fab700',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhovborder', [
                'label'     => __( 'Button Hover Border Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fab700',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnbg', [
                'label'       => __( 'Button Background Color', 'security' ),
                'type'        => Controls_Manager::COLOR,
                'default'     => '#fab700',
                'selectors'   => [
        ...
        $this->add_control(
            'color_btnhovbg', [
                'label'     => __( 'Button Hover Background Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
