 ...
 * @since 1.0
 */
class Security_Features extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_heading',
            [
                'label' => __( 'Features Section Heading', 'security' ),
            ]
        );
        $this->add_control(
            'sect_title', [
        ...
        $this->start_controls_section(
            'features_content',
            [
                'label' => __( 'Features', 'security' ),
            ]
        );
        $this->add_control(
            'features', [
                'label' => __( 'Create Features', 'security' ),
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'security' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Features Title ', 'security' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Font Icon', 'security' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_fonticon', [
                'label'     => __( 'Font Icon Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'fontsize',
            [
                'label' => __( 'Icon Font Size', 'security' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Descriptions', 'security' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Descriptions Color', 'security' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->start_controls_section(
			'style_featuresbox', [
				'label' => __( 'Style Features Box', 'security' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_control(
            'featuresbox_bgcolor',
            [
                'label'     => __( 'Style Features Box Background Color', 'security' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Hover Features Box Background Color ', 'security' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feature">
                        ...
                        //
                        if( ! empty( $val['desc'] ) ) {
                            echo security_get_textareahtml_output( $val['desc'] );
                        }
                        ?>
                    </div>
                </div>
