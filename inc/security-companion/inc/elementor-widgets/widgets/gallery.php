...
/**
 *
 * Security elementor Gallery.
 *
 * @since 1.0
 */
class Security_Gallery extends Widget_Base {

	public function get_name() {
		return 'security-gallery';
	}

	public function get_title() {
		return __( 'Gallery', 'security' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'gallery_heading',
            [
                'label' => __( 'Gallery Section Heading', 'security' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'gallery_content',
			[
				'label' => __( 'Gallery', 'security' ),
			]
		);
        $this->add_control(
            'gallery', [
                'label' => __( 'Create gallery', 'security' ),
